...
class TicketWorkflowController extends Controller
{
     ...
     */
    public function workflow($fromaddress, $fromname, $subject, $body, $phone, $phonecode, $mobile_number, $helptopic, $sla, $priority, $source, $collaborator, $dept, $assign, $team_assign, $ticket_status, $form_data, $kat_pemohon, $auto_response)
    {
