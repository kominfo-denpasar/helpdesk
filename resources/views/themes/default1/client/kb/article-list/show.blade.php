    ...
    <article class="hentry">
      ...
      <div class="entry-content clearfix">
        <blockquote class="blockquote archive-description" id="block" style="margin-bottom: 10px; margin-top: 10px;">
          <small>
            <a class="btn btn-sm btn-secondary" href="{{ url('article-list') }}"><i class="fa fa-angle-double-left"></i>
              &nbsp;{!! Lang::get('lang.back') !!}</a>
            @if ($arti->rules != null)
              <a class="btn btn-sm btn-warning" href="{{ url('rule/' . $arti->slug) }}"><i class="fa fa-edit"></i>
                &nbsp;{!! Lang::get('lang.rules') !!}</a>
            @endif
