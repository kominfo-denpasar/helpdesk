          ...
          <div class="collapse navbar-collapse links  justify-content-end" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav navbar-menu site-navigate ml-auto">
              ...
              <li @yield('kb') class="nav-item dropdown">
                <a href="{!! url('knowledgebase') !!}" class="dropdown-toggle nav-link" id="navbarDropdown" role="button"
                  data-toggle="" aria-haspopup="true" aria-expanded="false">{!! Lang::get('lang.knowledge_base') !!}
                </a>
            ...
            <div class="form-inline ">
              <div class="form-group input-group " style="width: 98% ">
                <input type="text" name="s" class="search-field form-control" title="Enter search term"
                  placeholder="Have a question? Type your search term here..." required="" style="width: 80%">
                <span class="input-group-btn">
                  <button type="submit" class="btn btn-custom btn-md "
                    style="margin-left: 20% ;background-color: #009aba; hov: #00c0ef; color: #fff ">Search</button>
                </span>
              </div>
