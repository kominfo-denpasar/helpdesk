      ...
      <div class="container">
        ...
        <nav id="navbar" class="site-navigation navbar navbar-expand-lg navbar-light">
          ...
          <button class="navbar-toggler custom-toggler" type="button" data-bs-toggle="collapse"
            ...
            aria-label="Toggle navigation" style="margin: 28px;float: right;">
          ...
          <div class="collapse navbar-collapse links justify-content-end" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav navbar-menu site-navigate ml-auto">
                ...
                <li @yield('pages') class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                    @foreach ($pages as $page)
                      <li><a href="{{ route('pages', $page->slug) }}" class="dropdown-item">{{ $page->name }}</a>
                      </li>
                    @endforeach
                  </ul>
                </li>
              ...
              @if (Auth::user())
                ...
                <li @yield('profile') class="nav-item dropdown">
                  <a href="#" class="dropdown-toggle nav-link" id="navbarDropdown" role="button"
                    data-toggle="" aria-haspopup="true" aria-expanded="false">{!! Lang::get('lang.my_profile') !!}
                  </a>
                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                    <li>
                      ...
                      <div class="banner-wrapper user-data text-center clearfix" id="profile_dropdown">
                        ...
                        <img id="user_avatar" src="{{ Auth::user()->profile_pic }}"class="avatar" alt="User Image"
                          height="70" width="70" />
                        ...
                        <div class="banner-content" id="dropdown_content">
                          ...
                          <a href="{{ url('auth/logout') }}" class="btn btn-custom btn-sm text-white profile_btn"
                            style="background-color: #003379; hov: #00c0ef; color: #fff "">{!! Lang::get('lang.log_out') !!}</a>

                          @if (Auth::user())
                            @if (Auth::user()->role != 'user')
                              <a href="{{ url('dashboard') }}" class="btn btn-custom btn-sm text-white profile_btn"
                          ...
                          @if (Auth::user())
                            @if (Auth::user()->role == 'user')
                              <a href="{{ url('client-profile') }}"
                                ...
                                style="background-color: #003379; hov: #00c0ef; color: #fff ">{!! Lang::get('lang.profile') !!}</a>
                            @endif
                          @endif
                        </div>
                      </div>
              ...
              @else
                @if (isset($errors))
                  <li class="nav-item">
                    ...
                    <a href="#" class="nav-link sfHover" data-bs-toggle="collapse"
              ...
              {{-- <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" style="right: -1px !important;left: auto !important;" role="menu"
                  aria-labelledby="dropdownMenu" id="lang_ul">
              ...
              <div class="row">
                ...
                <div class="col-md-12 text-center">
                  <button type="submit" class="btn btn-custom"
                    style="background-color: #003379; hov: #00c0ef; color: #fff ">{!! Lang::get('lang.login') !!}</button>
                  {!! Form::close() !!}
                </div>
          ...
          <div class="form-border" style="z-index: 0;width: 85%;">
            <div class="form-inline ">
              <div class="form-group input-group " style="width: 98% ">
                <input type="text" name="s" class="search-field form-control" title="Enter search term"
                  placeholder="Ada yang ingin ditanyakan? Ketik pencarian Anda di sini..." required=""
              ...
              <style>
                .search-field {
                  border-radius: 10px;
                  /* You can adjust the value to your desired radius */
                }
              </style>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="site-info col-md-6">
            <p class="text-muted">{!! Lang::get('lang.copyright') !!} &copy; 2023 - {!! date('Y') !!} <a
                href="{!! $company->website !!}" target="_blank">{!! $company->company_name !!}</a>.
              {!! Lang::get('lang.all_rights_reserved') !!}. <br>SPBE Kominfos Kota Denpasar.</p>
          </div>
                ...
                @if ($social->name == 'google')
                  @if ($social->value)
                    <li><a href="{{ $social->value }}" class="btn btn-social btn-google-plus" target="_blank"><i
                          class="fab fa-google-plus fa-fw"></i></a></li>
                  @endif
                @endif
                ...
                @if ($social->name == 'vimeo')
                  @if ($social->value)
                    <li><a href="{{ $social->value }}" class="btn btn-social btn-vimeo" target="_blank"><i
                          class="fab fa-vimeo-square fa-fw"></i></a></li>
                  @endif
                @endif
                ...
                @if ($social->name == 'pinterest')
                  @if ($social->value)
                    <li><a href="{{ $social->value }}" class="btn btn-social btn-pinterest" target="_blank"><i
                          class="fab fa-pinterest fa-fw"></i></a></li>
                  @endif
                @endif
                @if ($social->name == 'dribbble')
                  @if ($social->value)
                    <li><a href="{{ $social->value }}" class="btn btn-social btn-dribbble" target="_blank"><i
                          class="fab fa-dribbble fa-fw"></i></a></li>
                  @endif
                @endif
                @if ($social->name == 'flickr')
                  @if ($social->value)
                    <li><a href="{{ $social->value }}" class="btn btn-social btn-flickr" target="_blank"><i
                          class="fab fa-flickr fa-fw"></i></a></li>
                  @endif
                @endif
